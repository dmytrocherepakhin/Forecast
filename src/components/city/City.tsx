...
function City(): JSX.Element {
    ...
    return (
        <Wrapper>
            ...
            <p><img src={"http://openweathermap.org/img/wn/"+forecast?.weather[0].icon+"@4x.png"} alt="weather" /></p>
            <p>Temperature: {forecast?.main.temp ? (forecast?.main.temp-273.15).toFixed(1) : '---'} {'\u2103'}</p>
            <p>Feels_likefeels_like: {forecast?.main.feels_like ? (forecast?.main.feels_like-273.15).toFixed(1) : '---'} {'\u2103'}</p>
